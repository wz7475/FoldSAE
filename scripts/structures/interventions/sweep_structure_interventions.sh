...
sae_non_pair=${12:-"sae-ckpts/RFDiffSAE/patch_topk_expansion_factor32_k32_multi_topkFalse_auxk_alpha0.0lr0.005_homewzarzeckids_10000x_block_2merged_activations_block2_non_pair/block2_non_pair"}
sae_pair=${13:-""}
base_dir_for_config=${14:-"RFDiffSAE/config/saeinterventions/"}
python=${15:-"/home/wzarzecki/miniforge3/envs/rf/bin/python"}
prefix=${16:-"design"}
length=${17:-150}
coef_helix=${18:-"/home/wzarzecki/ds_10000x_block_2/coefs/non_pair_helix_no_timestep/coef.npy"}
coef_beta=${19:-"/home/wzarzecki/ds_10000x_block_2/coefs/non_pair_beta_no_timestep/coef.npy"}
coefs_output_dir=${20:-"/home/wzarzecki/ds_10000x_block_2/coefs_processed"}
